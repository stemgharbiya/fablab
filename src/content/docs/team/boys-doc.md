...
- ![anas](../../../assets/docs/team/anas-doc5.webp)
  - First of all, the design was made using `illustrator` program.
  - ![anas](../../../assets/docs/team/anas-doc1.webp)
  ...
  - ![anas](../../../assets/docs/team/anas-doc2.webp)
  - ![anas](../../../assets/docs/team/anas-doc3.webp)
  - Then, i used `inkscape` program to make a trace for each part of these parts.
  - ![anas](../../../assets/docs/team/anas-doc12.webp)
  - ![anas](../../../assets/docs/team/anas-doc13.webp)
  - ![anas](../../../assets/docs/team/anas-doc14.webp)
  - Then export them as `PNG` file.
  - ![anas](../../../assets/docs/team/anas-doc16.webp)
  - ![anas](../../../assets/docs/team/anas-doc17.webp)
  - Upload these files as `PNG` image to the site `fabmodules.org`.
  - ![anas](../../../assets/docs/team/anas-doc6.webp)
  - ![anas](../../../assets/docs/team/anas-doc7.webp)
  - Then use `camm` as output format ex. `File.camm`.
  - ![anas](../../../assets/docs/team/anas-doc8.webp)
  - The last option is the process, it will be `cut vinyl`.
  - ![anas](../../../assets/docs/team/anas-doc9.webp)
  ...
  - ![anas](../../../assets/docs/team/anas-doc11.webp)
  ...
  - ![anas](../../../assets/docs/team/anas-doc4.webp)

##  Emad saqr - laser cutter
- Installation steps
    - ![install1](../../../assets/docs/team/install1.webp)
    - ![install2](../../../assets/docs/team/install2.webp)
    - ![install3](../../../assets/docs/team/install3.webp)
    - ![install4](../../../assets/docs/team/install4.webp)
    - ![install5](../../../assets/docs/team/install5.webp)
    - ![install6](../../../assets/docs/team/install6.webp)
    - ![install7](../../../assets/docs/team/install7.webp)
    - ![install8](../../../assets/docs/team/install8.webp)
    - ![install9](../../../assets/docs/team/install9.webp)
- set the document
    - ![two](../../../assets/docs/team/two.webp)
    ...
    - ![three](../../../assets/docs/team/three.webp)
- Setting up an Object to be Cut
    ...
    - ![four](../../../assets/docs/team/four.webp)
- setting up an object to be rastered
    ...
    - ![five](../../../assets/docs/team/five.webp)
- print the job on laser
    ...
    - ![seven](../../../assets/docs/team/seven.webp)
    - Resolution (only if you are engraving)
        ...
        - ![eight](../../../assets/docs/team/Screenshot_20190827_130610.webp)
    - Job Type : There are three different types of job types on the laser cutter
        ...
        - ![nine](../../../assets/docs/team/eight.webp)
    - Options
        ...
        - ![ten](../../../assets/docs/team/nine.webp)
    - Piece Size
        ...
        - ![elev](../../../assets/docs/team/ten.webp)
    - Raster Settings (if applicable) : If you are doing any engraving you will need to set :
        ...
        - ![twel](../../../assets/docs/team/elev.webp)
        - ![thirt](../../../assets/docs/team/twel.webp)
        - ![fourt]../../../assets/docs/team/(thirt.webp)
    - Vector Settings (if applicable) : If you are doing any cutting you will need to set :
        ...
        - ![fifte](../../../assets/docs/team/fourt.webp)
    - Sending the Job
        ...
        - ![fift](../../../assets/docs/team/fifte.webp)
