...
- Hardware
  ...
  - Wires need to hoock up
    ...
    - ![isp](../../../../assets/docs/challenges/isp.webp)
- Software
  ...
  - ![arduino](../../../../assets/docs/challenges/arduino.webp)
  - make file
...
- serial communication
  ...
  - `UART` serial : universal asynchronous receive and transmit is the most common serial mode
    ...
    - ![osc](../../../../assets/docs/challenges/osc.webp)
    - ![osc2](../../../../assets/docs/challenges/osc2.webp)
...
- push button
  ...
  - ![push](../../../../assets/docs/challenges/push-button.webp)
  ...
  - ![pull-up](../../../../assets/docs/challenges/pull-up.webp)
