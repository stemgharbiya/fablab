...
- Hardware
  ...
  - Wires need to hoock up
    ...
    - ![isp](../../../../assets/docs/challenges/isp.png)
- Software
  ...
  - ![arduino](../../../../assets/docs/challenges/arduino.png)
  - make file
...
- serial communication
  ...
  - `UART` serial : universal asynchronous receive and transmit is the most common serial mode
    ...
    - ![osc](../../../../assets/docs/challenges/osc.png)
    - ![osc2](../../../../assets/docs/challenges/osc2.png)
...
- push button
  ...
  - ![push](../../../../assets/docs/challenges/push-button.png)
  ...
  - ![pull-up](../../../../assets/docs/challenges/pull-up.png)
