...
- Java code components
  ...
  - attribute
  - methods
  - ![java](../../../../assets/docs/challenges/java-components.webp)
  - ![java2](../../../../assets/docs/challenges/java-components2.webp)

## [Syntax symbols](https://www.udemy.com/course/become-an-android-developer-from-scratch/learn/lecture/1009678#overview)

- ![symbols](../../../../assets/docs/challenges/symbols.webp)
...
- there are five components for the java method signature
  ...
  - ![method](../../../../assets/docs/challenges/method.webp)
  - ![method](../../../../assets/docs/challenges/method2.webp)
...
- ![pointer](../../../../assets/docs/challenges/pointer.webp)
- there are two different data types
- ![data](../../../../assets/docs/challenges/data-types.webp)
- it is better to reduce the usable memory as possible
- ![variable](../../../../assets/docs/challenges/variables.webp)
